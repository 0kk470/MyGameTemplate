...
namespace UnityEditor.UI
{
    static internal class MyMenuOptions
    {
        ...
        {
            GameObject go = MyDefaultControls.CreateLoopHorizontalScrollRect(GetStandardResources());
        ...
        {
            GameObject go = MyDefaultControls.CreateLoopVerticalScrollRect(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }


        [MenuItem("Tools/ClearAllPlayerPrefs", false)]
        public static void ClearAllPlayerPrefs()
        {
            EasyPlayerPrefs.DeleteAll();
        }
    }
}